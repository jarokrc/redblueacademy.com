const enServices = {
  pages: {
    services: {
      title: "Services",
      lead: "Overview of services and focus.",
    },
  },
  servicesPage: {
    ...
    tracks: [
      {
        title: "Python",
        subtitle: "A practical language for the modern world",
        bullets: [
          "Core syntax, logic, and algorithms",
          "Web apps with Django and Flask, APIs",
          "Automation and data fundamentals",
        ],
        imageAlt: "Python code on screen",
      },
      {
        title: "C#",
        subtitle: "A powerful tool for modern applications",
        bullets: [
          "Modern .NET stack for stable apps",
          "Blazor for web and WinForms/WPF for desktop",
          "Databases, APIs, and internal business tools",
        ],
        imageAlt: "C# application on screen",
      },
    ],
    moreInfo: "More info",
    quote: {
      ...
      author: "Confucius",
      role: "Chinese teacher and philosopher",
    },
  },
};
