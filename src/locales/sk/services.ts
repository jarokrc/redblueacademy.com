const skServices = {
  pages: {
    services: {
      title: "Služby",
      lead: "Prehľad služieb a zamerania.",
    },
  },
  servicesPage: {
    ...
    tracksTitle: "Čo sa môžete naučiť?",
    tracks: [
      {
        title: "Python",
        subtitle: "Praktický jazyk pre moderný svet",
        bullets: [
          "Základy syntaxe, logiky a algoritmov",
          "Webové aplikácie s Django a Flask, API",
          "Automatizácia a základy práce s dátami",
        ],
        imageAlt: "Ukážka kódu v Pythone",
      },
      {
        title: "C#",
        subtitle: "Silný nástroj pre moderné aplikácie",
        bullets: [
          "Moderný .NET stack pre stabilné aplikácie",
          "Blazor pre web a WinForms/WPF pre desktop",
          "Databázy, API a interné firemné nástroje",
        ],
        imageAlt: "Ukážka aplikácie v C#",
      },
    ],
    moreInfo: "Viac info",
    quote: {
      text: "Cesta dlhá tisíc míľ sa začína jediným krokom.",
      author: "Konfucius",
      role: "čínsky učiteľ a filozof",
    },
  },
};
